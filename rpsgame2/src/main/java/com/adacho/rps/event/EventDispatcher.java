...
public class EventDispatcher {
	...
	EventDispatcher(final RabbitTemplate rabbitTemplate, @Value("${rps.exchange}") final String rpsExchange,
			@Value("${rps.solved.key}") final String rpsSolvedRoutingKey) {
