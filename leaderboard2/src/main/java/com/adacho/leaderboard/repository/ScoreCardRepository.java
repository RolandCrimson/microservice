...
public interface ScoreCardRepository extends JpaRepository<ScoreCard, Long> {
	 ...
	 */
	@Query("SELECT NEW com.adacho.leaderboard.domain.LeaderBoardRow(s.userId, SUM(s.score)) "
			+ "FROM com.adacho.leaderboard.domain.ScoreCard s " + "GROUP BY s.userId ORDER BY SUM(s.score) DESC")
